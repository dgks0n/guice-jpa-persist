package org.apache.onami.oldPersist.testframework;
...
import org.apache.onami.oldPersist.EntityManagerProvider;
import org.apache.onami.oldPersist.Transactional;
import org.apache.onami.oldPersist.UnitOfWork;

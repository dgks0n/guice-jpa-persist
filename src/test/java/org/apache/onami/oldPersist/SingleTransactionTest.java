...
import org.apache.onami.oldPersist.testframework.TransactionalWorker;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnAnyThrowingNone;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnAnyThrowingRuntimeTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnAnyThrowingTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnNoneThrowingNone;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnNoneThrowingRuntimeTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnNoneThrowingTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnRuntimeTestExceptionThrowingNone;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnRuntimeTestExceptionThrowingRuntimeTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnRuntimeTestExceptionThrowingTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnTestExceptionThrowingNone;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnTestExceptionThrowingRuntimeTestException;
import org.apache.onami.oldPersist.testframework.tasks.TaskRollingBackOnTestExceptionThrowingTestException;
